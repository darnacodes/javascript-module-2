...
function colorRandomChange(){
    ...
    const r= Math.floor(Math.floor(Math.random() * (255 - 0 + 1) + 0));
    const g= Math.floor(Math.floor(Math.random() * (255 - 0 + 1) + 0));
    const b= Math.floor(Math.floor(Math.random() * (255 - 0 + 1) + 0));
